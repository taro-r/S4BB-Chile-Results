...
"""
# Taro's notes - bandpower just refers to the reading at a given frequency band (in this case the angular power spectrum reading)
# so is the lensing template a kind of bandpower window function?
import numpy as np
from s4bb.util import specind, specgen
