...
import numpy as np
import s4bb.bandpass as bandpass
...
def specind(nmap, m0, m1):
    ...
    Notes
    -----
    Return value doesn't depend on the ordering of m0 vs m1.
...
class MapDef():
    ...
    def copy(self, update_field=None):
        ...
        This is not a deep copy! Notably, the bandpass for the new MapDef object
        will be a reference to the same bandpass as the original MapDef object.
